...
- A roughly four-minute route at the default cruising speed, separate navigable year/story and life-stage tracks, chapter checkpoint dots, and a shoreline progress indicator. Direct chapter navigation and the readable overview provide shorter ways to explore. Story text keeps revealing when the rider stops.
...
- A Revision Marine workshop drive-by, followed by a forward-looking final chapter and visible FINISH line. Back to start appears at the actual finish. Readable timeline navigation, keyboard and touch controls, and reduced-motion support remain available.
