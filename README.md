...
- Cleveland lakefront pixel skyline including the Browns stadium, Sherwin-Williams headquarters, generic muted red crown accents on Key Tower, and the Rock Hall's glass pyramid. An unbranded pixel blimp enters from the right near the end of the ride. Includes a taller responsive scene and optional browser full-screen mode. No stock photography or generated image assets are used for the game.
