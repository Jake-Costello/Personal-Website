...
- Use the same club-head artwork for the bag, dragged club, and held club, including the idle pose after a shot. Layer the arms, hands, and shaft behind the torso/head when the swing carries them behind the body. After a 90 ms address pause, use 540 ms for the backswing and 270 ms for the forward swing to contact (2:1 rhythm).
