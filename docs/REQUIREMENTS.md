...
- Offer white, a bright yellow ball earned by beating the jetski time trial, and one gray disabled “Mystery achievement” placeholder. Keep white selected until the visitor explicitly chooses yellow. Apply the selected color to both the tee ball and flying fact ball, with dimples on both colors. Yellow uses the existing facts; additional achievements and fact collections remain future work. A future pink ball could reveal more personal facts or project ideas.
