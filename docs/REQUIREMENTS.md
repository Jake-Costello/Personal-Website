...
- Show the golfer's left-side profile at address: hips hinged, knees flexed, head looking down, and hands below the near shoulder with an angled shaft reaching the ball. Swing poses include a backswing, downswing, and a finish supported on the lead leg with the trail heel raised.
