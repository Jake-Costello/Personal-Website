...
- The pixel character wears a black hat, blue shirt with white flowers, black pants, and tan shoes, with a light skin tone, a small brown mustache, and curly hair peeking beneath the cap. Jacob is right-handed; use his requested mirrored stance and swing, with the ball traveling toward the screen. Mirror the tee and impact with the golfer and align the flight origin with the mirrored ball.
